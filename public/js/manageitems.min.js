...
function loadImages(a) {
    var b = SERVER_ABSOLUTE_PATH + "/objets/getEncodedImagesById";
    $.ajax({
        type: "POST",
        url: b,
        data: {
        ...
        success: function(a) {
            ...
            for (var c = 0; c < b.length; c++) $("#imageList").append('<li class="th [radius]"><img  data-image-id="' + b[c].ImageId + '" src="' + b[c].ImageBlob + '" alt="Image de l\'objet en cours"></li>')
        }
    })
}
